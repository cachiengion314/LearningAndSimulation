...
public class DistortTunnelPass_Tunnel : ScriptableRenderPass
{
    ...
    public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
    {
        ...
        // just take out the stuffs that is stored in the first pass
        ...
        // we choose destination for tunnelObject simply a TextureHandle and not directly cameraColorTexture duo to the fact that at later, we need
        // this kind of information for another pass that have a mission to distort the final image

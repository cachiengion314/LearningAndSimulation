...
public class DistortTunnelPass_CopyColor : ScriptableRenderPass
{
    ...
    public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
    {
        ...
        texRefData.distortTunnelTexHandle = destination; // storing entirely 2Dtexture data into distortTunnelTexHandle if Blit operation perform successfully
        ...
        }; // perform the blit operation with a newly creating on the fly material
